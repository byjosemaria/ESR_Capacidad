/*  MEDIDOR DE ESR EN CONDENSADORES
El condensador se conecta entre puerto A5 y Tierra. Se genera una corriente pulsante/alterna, de periodo T=4  us (2+2) => f= 250 KHz).
...
Para un condensador de 10uF sería Xc = 0,06366 Ω y para un condensador 100 uF sería de Xc = 0,006366 Ω. Ysi fueran mas pequeño, ej 0,01 uf entonces Xc = 127,323954 Ω.
IMPORTANTE:
----------
...
//Medimos tensión de entrad REAL.
int refADC(){
   long result;
